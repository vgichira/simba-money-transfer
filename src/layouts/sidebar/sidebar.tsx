...
return (
    <>
        <aside id="sidebar" className="fixed hidden z-20 h-full top-0 left-0 pt-6 flex lg:flex flex-shrink-0 flex-col w-64 transition-width duration-75" aria-label="Sidebar">
